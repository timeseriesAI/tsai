# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/100b_models.layers.ipynb (unless otherwise specified).

__all__ = ['noop', 'SwishBeta', 'same_padding1d', 'Pad1d', 'Conv1dSame', 'Conv1dCausal', 'Conv1d', 'SeparableConv1d',
           ...
           'LambdaPlus', 'Squeeze', 'Unsqueeze', 'Add', 'Concat', 'Permute', 'Transpose', 'View', 'Reshape', 'Max',
           'LastStep', 'Noop', 'Sharpen', 'MaxPPVPool1d', 'MPPV1d', 'Temp_Scale', 'Vector_Scale', 'Matrix_Scale',
           'get_calibrator', 'GAP1d', 'GACP1d', 'SqueezeExciteBlock', 'create_pool_head', 'create_pool_plus_head',
           'create_mlp_head', 'create_conv_head', 'change_model_head', 'GaussianNoise', 'gambler_loss',
