...
__all__ = ['InceptionTimePlus', 'InCoordTime', 'XCoordTime', 'InceptionTimePlus17x17', 'InceptionTimePlus32x32',
...
class _InceptionModulePlus(Module):
...
@delegates(_InceptionModulePlus.__init__)
class _InceptionBlockPlus(Module):
    def __init__(self, ni, nf, residual=True, depth=6, coord=False, norm='Batch', zero_norm=False, act=nn.ReLU, act_kwargs={}, sa=False, se=None,
        ...
        for d in range(depth):
            self.inception.append(_InceptionModulePlus(ni if d == 0 else nf * 4, nf, coord=coord, norm=norm,
...
class InceptionTimePlus(nn.Sequential):
    def __init__(self, c_in, c_out, seq_len=None, nf=32, nb_filters=None, depth=6, stoch_depth=1.,
        ...
        backbone = _InceptionBlockPlus(c_in, nf, depth=depth, keep_prob=keep_prob, **kwargs)
