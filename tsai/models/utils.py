...
__all__ = ['apply_idxs', 'SeqEmbed', 'get_layers', 'is_layer', 'is_linear', 'is_bn', 'is_conv_linear',
...
# Cell
def SeqEmbed(c_in, embed_dim, seq_size):
    "Embeds subsequences within a long sequence"
    return nn.Conv1d(c_in, embed_dim, seq_size, stride=seq_size)
