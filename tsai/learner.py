...
all_archs_names = ['FCN', 'FCNPlus', 'InceptionTime', 'InceptionTimePlus', 'InCoordTime', 'XCoordTime', 'InceptionTimePlus17x17', 'InceptionTimePlus32x32',
                   ...
                   'MiniRocketHead', 'InceptionRocketFeaturesPlus', 'InceptionRocketPlus', 'MLP', 'gMLP', 'gMLPClassification', 'MultiInputNet', 'OmniScaleCNN', 'RNN', 'LSTM', 'GRU',
...
def get_arch(arch_name):
    if arch_name == "FCN":
        ...
        arch = gMLP
    elif arch_name == "gMLPClassification":
        from .models.gMLP import gMLPClassification
        arch = gMLPClassification
