"""Docs: https://timeseriesAI.github.io/tsaiutils.html.md"""
...
# %% ../nbs/002_utils.ipynb #8787b975
def is_np_view(
    o# a numpy array
):
    return hasattr(o, "base") and o.base is not None

# %% ../nbs/002_utils.ipynb #cbc6dc20
def is_file(path):
...
# %% ../nbs/002_utils.ipynb #3d9ca592
def reverse_dict(dictionary):
    return {v: k for k, v in dictionary.items()}

# %% ../nbs/002_utils.ipynb #bd7951b5
def is_tuple(o): return isinstance(o, tuple)

# %% ../nbs/002_utils.ipynb #8bff498f
...
# %% ../nbs/002_utils.ipynb #1b71b4b9
def assert_fn(*args, **kwargs): assert False, 'assertion test'
test_error('assertion test', assert_fn, 35, a=3)

# %% ../nbs/002_utils.ipynb #f38b0e81
def test_gt(a,b):
    "`test` that `a>b`"
    test(a,b,gt,'>')
...
# %% ../nbs/002_utils.ipynb #46f28e25
def match_seq_len(*arrays):
    max_len = stack([x.shape[-1] for x in arrays]).max()
    return [np.pad(x, pad_width=((0,0), (0,0), (max_len - x.shape[-1], 0)), mode='constant', constant_values=0) for x in arrays]

# %% ../nbs/002_utils.ipynb #0c216f8d
...
# %% ../nbs/002_utils.ipynb #a34294f0
def get_idx_from_df_col_vals(df, col, val_list):
    return [df[df[col] == val].index[0] for val in val_list]

# %% ../nbs/002_utils.ipynb #8ad59d84
def get_sublist_idxs(aList, bList):
    "Get idxs that when applied to aList will return bList. aList must contain all values in bList"
    sorted_aList = aList[np.argsort(aList)]
    return np.argsort(aList)[np.searchsorted(sorted_aList, bList)]

# %% ../nbs/002_utils.ipynb #47ae4e10
def flatten_list(l):
    return [item for sublist in l for item in sublist]

# %% ../nbs/002_utils.ipynb #6bb55774
...
# %% ../nbs/002_utils.ipynb #1d58544c
def get_idxs(o, aList): return array([o.tolist().index(v) for v in aList])

# %% ../nbs/002_utils.ipynb #0b19aaba
...
# %% ../nbs/002_utils.ipynb #8ae57a24
def cls_name(o): return o.__class__.__name__

# %% ../nbs/002_utils.ipynb #103cb453
...
# %% ../nbs/002_utils.ipynb #a8b3e5db
def mpl_trend(x, y, deg=1):
    return np.poly1d(np.polyfit(x, y, deg))(x)

# %% ../nbs/002_utils.ipynb #1f9733b0
...
# %% ../nbs/002_utils.ipynb #597ce437
def sort_generator(generator, bs):
    g = list(generator)
    for i in range(len(g)//bs + 1): g[bs*i:bs*(i+1)] = np.sort(g[bs*i:bs*(i+1)])
    return (i for i in g)

# %% ../nbs/002_utils.ipynb #00d76d99
def get_subset_dict(d, keys):
    return dict((k,d[k]) for k in listify(keys) if k in d)

# %% ../nbs/002_utils.ipynb #fdd3e97c
...
# %% ../nbs/002_utils.ipynb #12e7cfdd
alphabet = L(list(string.ascii_lowercase))
ALPHABET = L(list(string.ascii_uppercase))

# %% ../nbs/002_utils.ipynb #dc64b457
...
# %% ../nbs/002_utils.ipynb #cf8ea4c6
def to_sincos_time(arr, max_value):
    sin = np.sin(arr / max_value * 2 * np.pi)
    cos = np.cos(arr / max_value * 2 * np.pi)
    return sin, cos

# %% ../nbs/002_utils.ipynb #4bd4edea
...
# %% ../nbs/002_utils.ipynb #2cfb293d
def feat2list(o):
    if o is None: return []
    elif isinstance(o, str): return [o]
    return list(o)

# %% ../nbs/002_utils.ipynb #0939f8d9
