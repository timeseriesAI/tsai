...
# %% auto 0
__all__ = ['rng', 'bytes2size', 'b2s', 'memmap2cache', 'cache_memmap', 'a', 'b', 'np_save', 'create_empty_array', 'dict2attrdict',
           'alphabet', 'ALPHABET', 'random_choice', 'random_randint', 'random_rand', 'is_nparray', 'is_tensor',
           'is_zarr', 'is_dask', 'is_memmap', 'is_slice', 'totensor', 'toarray', 'toL', 'to3dtensor', 'to2dtensor',
           'to1dtensor', 'to3darray', 'to2darray', 'to1darray', 'to3d', 'to2d', 'to1d', 'to2dPlus', 'to3dPlus',
           'to2dPlusTensor', 'to2dPlusArray', 'to3dPlusTensor', 'to3dPlusArray', 'todtype', 'bytes2str', 'get_size',
           'get_dir_size', 'get_file_size', 'is_np_view', 'is_file', 'is_dir', 'delete_all_in_dir', 'reverse_dict',
           'is_tuple', 'itemify', 'isnone', 'exists', 'ifelse', 'is_not_close', 'test_not_close', 'test_type',
           'test_ok', 'test_not_ok', 'test_error', 'test_eq_nan', 'assert_fn', 'test_gt', 'test_ge', 'test_lt',
           'test_le', 'stack', 'stack_pad', 'pad_sequences', 'match_seq_len', 'random_shuffle', 'cat2int', 'cycle_dl',
           'cycle_dl_to_device', 'cycle_dl_estimate', 'cache_data', 'get_func_defaults', 'get_idx_from_df_col_vals',
           'get_sublist_idxs', 'flatten_list', 'display_pd_df', 'ttest', 'kstest', 'tscore', 'pcc', 'scc', 'remove_fn',
           'npsave', 'permute_2D', 'random_normal', 'random_half_normal', 'random_normal_tensor',
           ...
           'is_memory_shared', 'assign_in_chunks', 'create_array', 'np_save_compressed', 'np_load_compressed',
           ...
           'get_subset_dict', 'create_dir', 'remove_dir', 'named_partial', 'dict2yaml', 'yaml2dict', 'get_config',
           'str2list', 'str2index', 'get_cont_cols', 'get_cat_cols', 'get_mapping', 'map_array', 'log_tfm',
