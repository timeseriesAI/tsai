...
__all__ = ['memmap2cache', 'cache_memmap', 'a', 'b', 'np_save', 'create_empty_array', 'alphabet', 'ALPHABET', 'is_nparray',
           ...
           'ttest_tensor', 'pcc', 'scc', 'remove_fn', 'npsave', 'permute_2D', 'random_normal', 'random_half_normal',
           ...
           'split_in_chunks', 'save_object', 'load_object', 'get_idxs_to_keep']
...
# %% ../nbs/001_utils.ipynb 149
alphabet = L(list(string.ascii_lowercase))
ALPHABET = L(list(string.ascii_uppercase))

# %% ../nbs/001_utils.ipynb 150
