...
__all__ = ['df2Xy', 'split_Xy', 'df2xy', 'split_xy', 'df2np3d', 'SlidingWindow', 'SlidingWindowSplitter',
           'SlidingWindowPanel', 'SlidingWindowPanelSplitter']
...
def df2np3d(df, groupby, data_cols=None):
    """Transforms a df with the same mber of rows per group in groupby to a 2d ndarray"""
