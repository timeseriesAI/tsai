"""Docs: https://timeseriesAI.github.io/tsaidata.preparation.html.md"""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/004_data.preparation.ipynb.

# %% ../../nbs/004_data.preparation.ipynb #58cfe9f3
...
# %% ../../nbs/004_data.preparation.ipynb #624c3b7e
...
# %% ../../nbs/004_data.preparation.ipynb #c04fe30c
...
# %% ../../nbs/004_data.preparation.ipynb #66ce2d29
...
# %% ../../nbs/004_data.preparation.ipynb #b90d9d69
...
# %% ../../nbs/004_data.preparation.ipynb #dfaab122
...
# %% ../../nbs/004_data.preparation.ipynb #10c8c439
def add_missing_timestamps(
    ...
    if unique_id_cols is not None:
        ...
        if range_by_group:
            ...
            df = df.reindex(multi_idx, fill_value=fill_value)
            df.reset_index(inplace=True)
        else:
        ...
        df = df.reindex(index, fill_value=fill_value)
        df.reset_index(inplace=True)
    if use_index:
        df.set_index(datetime_col, inplace=True)
    return df

# %% ../../nbs/004_data.preparation.ipynb #67ff1d18
...
# %% ../../nbs/004_data.preparation.ipynb #7cc10bdd
...
# %% ../../nbs/004_data.preparation.ipynb #17423f89
...
# %% ../../nbs/004_data.preparation.ipynb #b2067ee9
...
# %% ../../nbs/004_data.preparation.ipynb #a0bd1a64
...
# %% ../../nbs/004_data.preparation.ipynb #6bdd87b4
...
# %% ../../nbs/004_data.preparation.ipynb #e5f5a46c
...
# %% ../../nbs/004_data.preparation.ipynb #60824495
...
# %% ../../nbs/004_data.preparation.ipynb #19b26e3f
...
# %% ../../nbs/004_data.preparation.ipynb #394f950d
...
# %% ../../nbs/004_data.preparation.ipynb #883641c2
...
# %% ../../nbs/004_data.preparation.ipynb #8e4c97e2
def get_fcst_bounds(
    df,  # dataframe containing forecasting data
...
# %% ../../nbs/004_data.preparation.ipynb #0a591a0c
...
# %% ../../nbs/004_data.preparation.ipynb #e9504781
