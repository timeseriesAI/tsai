# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/017_data.transforms.ipynb (unless otherwise specified).

__all__ = ['TSIdentity', 'TSShuffle_HLs', 'TSShuffleSteps', 'TSGaussianNoise', 'TSMagAddNoise', 'TSMagMulNoise',
           ...
           'TSMagScalePerVar', 'TSMagScaleByVar', 'TSRandomResizedCrop', 'TSRandomZoomIn', 'TSWindowSlicing',
           'TSRandomZoomOut', 'TSRandomTimeScale', 'TSRandomTimeStep', 'TSResampleSteps', 'TSSubsampleSteps', 'TSBlur',
           ...
           'TSInputDropout', 'TSTranslateX', 'TSRandomShift', 'TSHorizontalFlip', 'TSRandomTrend', 'TSRandomRotate',
           'TSVerticalFlip', 'TSResize', 'TSRandomSize', 'TSRandomLowRes', 'TSDownUpScale', 'TSRandomDownUpScale',
           'TSRandomConv', 'TSRandom2Value', 'TSMask2Value', 'all_TS_randaugs', 'RandAugment', 'TestTfm',
           'get_tfm_name']
