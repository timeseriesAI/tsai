...
__all__ = ['GamblersCallback', 'TransformScheduler', 'ShowGraphCallback2', 'UBDA']
...
class UBDA(Callback):
    ...
    def __init__(self, batch_tfms:list, N:int=2, C:int=4, S:int=1):
        ...
        self.n_tfms = len(batch_tfms)
        self.N = min(N, len(batch_tfms))
    ...
    def before_batch(self):
        if self.training:
            ...
            if self.S > 1:
                ...
                self.learn.yb = (torch_tile(self.y, 2),)
            self.learn.xb = (x2,)