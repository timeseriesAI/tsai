...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'tsai.all': {},
            ...
            'tsai.data.all': {},
            'tsai.data.basics': {},
            'tsai.data.core': { 'tsai.data.core.(NumpyDatasets, TSDatasets).add_dataset': ( 'data.core.html#(numpydatasets, '
                                                                                            'tsdatasets).add_dataset',
                                                                                            'tsai/data/core.py'),
                                'tsai.data.core.(NumpyDatasets, TSDatasets).add_test': ( 'data.core.html#(numpydatasets, '
                                                                                         'tsdatasets).add_test',
                                                                                         'tsai/data/core.py'),
                                'tsai.data.core.(NumpyDatasets, TSDatasets).add_unlabeled': ( 'data.core.html#(numpydatasets, '
                                                                                              'tsdatasets).add_unlabeled',
                                                                                              'tsai/data/core.py'),
                                'tsai.data.core.NoTfmLists': ('data.core.html#notfmlists', 'tsai/data/core.py'),
