...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'tsai.all': {},
            ...
            'tsai.data.core': { 'tsai.data.core.NoTfmLists': ('data.core.html#notfmlists', 'tsai/data/core.py'),
                                ...
                                'tsai.data.core.NumpyDataLoader.new': ('data.core.html#numpydataloader.new', 'tsai/data/core.py'),
            ...
            'tsai.data.preparation': { 'tsai.data.preparation.SlidingWindow': ( 'data.preparation.html#slidingwindow',
                                       ...
                                       'tsai.data.preparation.time_encoding': ( 'data.preparation.html#time_encoding',
                                                                                'tsai/data/preparation.py')},
            'tsai.data.preprocessing': { 'tsai.data.preprocessing.(torch.Tensor, TSTensor, NumpyTensor).mul_max': ( 'data.preprocessing.html#(torch.tensor, '
                                                                                                                    'tstensor, '
                                                                                                                    'numpytensor).mul_max',
                                                                                                                    'tsai/data/preprocessing.py'),
                                         'tsai.data.preprocessing.(torch.Tensor, TSTensor, NumpyTensor).mul_min': ( 'data.preprocessing.html#(torch.tensor, '
                                                                                                                    'tstensor, '
                                                                                                                    'numpytensor).mul_min',
                                                                                                                    'tsai/data/preprocessing.py'),
