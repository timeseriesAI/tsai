  ...
  'syms': { 'tsai.all': {},
            ...
            'tsai.data.preparation': { 'tsai.data.preparation.SlidingWindow': ( 'data.preparation.html#slidingwindow',
                                       ...
                                       'tsai.data.preparation.time_encoding': ( 'data.preparation.html#time_encoding',
                                                                                'tsai/data/preparation.py')},
            'tsai.data.preprocessing': { 'tsai.data.preprocessing.ApplyFunction': ( 'data.preprocessing.html#applyfunction',
                                                                                    'tsai/data/preprocessing.py'),
                                         'tsai.data.preprocessing.ApplyFunction.__init__': ( 'data.preprocessing.html#applyfunction.__init__',
                                                                                             'tsai/data/preprocessing.py'),
                                         'tsai.data.preprocessing.ApplyFunction.fit': ( 'data.preprocessing.html#applyfunction.fit',
                                                                                        'tsai/data/preprocessing.py'),
                                         'tsai.data.preprocessing.ApplyFunction.inverse_transform': ( 'data.preprocessing.html#applyfunction.inverse_transform',
                                                                                                      'tsai/data/preprocessing.py'),
                                         'tsai.data.preprocessing.ApplyFunction.transform': ( 'data.preprocessing.html#applyfunction.transform',
                                                                                              'tsai/data/preprocessing.py'),
                                         'tsai.data.preprocessing.NumpyTensor.mul_max': ( 'data.preprocessing.html#numpytensor.mul_max',
                                                                                          'tsai/data/preprocessing.py'),
